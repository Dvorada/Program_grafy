...
with open("C:\Test\A_00.csv", "r") as file:
...
plt.plot(X,Y, 'r-', label="F/t")
# Přidáme titulek grafu
plt.title("Graf Jablko A_00")
# Přidáme popisky os
plt.xlabel("t[msec]")
plt.ylabel("F[N]")
plt.legend()
...
# Graf funkce
ax1.plot(X, Y, 'r-', label="F/t")
ax1.set_xlabel('t[msec]')
ax1.set_ylabel('F[N]')
ax1.set_title('Graf Jablko A_00')
ax1.legend()
